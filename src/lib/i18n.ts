...
const en: Dict = {
  ...
  // ===== Dashboard BI =====
  'bi.dashboard.subtitle': 'Cross-platform delivery + growth funnel, by date range',
  'bi.filter.os': 'OS',
  'bi.filter.source': 'Source',
  'bi.filter.platform': 'Channel',
  'bi.filter.agency': 'Agency',
  'bi.os.ios': 'iOS',
  'bi.os.android': 'Android',
  'bi.os.web': 'PC',
  'bi.source.paid': 'Paid',
  'bi.source.organic': 'Organic',
  'bi.table.os_summary.title': 'OS × Source Summary',
  'bi.table.breakdown.title': 'Delivery Detail',
  'bi.table.totals': 'Total',
  'bi.table.mode.daily': 'By day',
  'bi.table.mode.aggregate': 'Aggregate range',
  'bi.table.mode.label': 'Display',
  'bi.col.date': 'Date',
  'bi.col.date_range': 'Range',
  'bi.col.os': 'OS',
  'bi.col.source': 'Source',
  'bi.col.platform': 'Channel',
  'bi.col.agency': 'Agency',
  'bi.col.spend': 'Spend',
  'bi.col.signups': 'Signups',
  'bi.col.cost_per_signup': 'Cost/Signup',
  'bi.col.d1_rate': 'D1',
  'bi.col.d7_rate': 'D7',
  'bi.col.d0_roi': 'D0 ROI',
  'bi.col.d7_roi': 'D7 ROI',
  'bi.col.subscription_rate': 'Pay rate',
  'bi.col.arpu7d': '7d ARPU',
  'bi.col.arppu7d': '7d ARPPU',
  'bi.col.trial_to_paid_rate': 'Trial→Paid',
  'bi.col.trials': 'Trials',
  'bi.col.subscribers': 'Payers',
  'bi.col.cost_per_paying_user': 'Cost/Payer',
  'bi.col.revenue_to_date': 'Revenue',
  'bi.col.revenue_to_date_title': 'Revenue to date of cohorts acquired in the range; for ranges ending today this equals in-range revenue',
  'bi.col.revenue_d0': 'D0 revenue',
  'bi.col.revenue_d7': 'D7 revenue',
  'bi.col.impressions': 'Impressions',
  'bi.col.clicks': 'Clicks',
  'bi.col.cpc': 'CPC',
  'bi.col.pending_title': 'Attribution join pending — funnel metrics not yet bridged from Report to CohortSnapshot',
  'bi.empty.summary': 'No cohort data for this range yet',
  'bi.empty.breakdown': 'No delivery data for this range yet',
  'bi.legacy.title': 'Legacy overview (kept below)',
}
...
const zh: Dict = {
  ...
  // ===== 仪表盘 BI =====
  'bi.dashboard.subtitle': '跨平台投放与增长漏斗，按日期区间查看',
  'bi.filter.os': '系统',
  'bi.filter.source': '来源',
  'bi.filter.platform': '渠道',
  'bi.filter.agency': '代理商',
  'bi.os.ios': 'iOS',
  'bi.os.android': 'Android',
  'bi.os.web': 'PC',
  'bi.source.paid': '付费',
  'bi.source.organic': '自然',
  'bi.table.os_summary.title': '分端汇总',
  'bi.table.breakdown.title': '投放明细',
  'bi.table.totals': '合计',
  'bi.table.mode.daily': '按天',
  'bi.table.mode.aggregate': '汇总区间',
  'bi.table.mode.label': '显示',
  'bi.col.date': '日期',
  'bi.col.date_range': '区间',
  'bi.col.os': '系统',
  'bi.col.source': '来源',
  'bi.col.platform': '渠道',
  'bi.col.agency': '代理商',
  'bi.col.spend': '花费',
  'bi.col.signups': '注册量',
  'bi.col.cost_per_signup': '注册成本',
  'bi.col.d1_rate': '次留率',
  'bi.col.d7_rate': '七留率',
  'bi.col.d0_roi': 'D0 ROI',
  'bi.col.d7_roi': 'D7 ROI',
  'bi.col.subscription_rate': '付费率',
  'bi.col.arpu7d': '7日ARPU',
  'bi.col.arppu7d': '7日ARPPU',
  'bi.col.trial_to_paid_rate': '试用付费率',
  'bi.col.trials': '试用人数',
  'bi.col.subscribers': '付费人数',
  'bi.col.cost_per_paying_user': '付费成本',
  'bi.col.revenue_to_date': '付费金额',
  'bi.col.revenue_to_date_title': '所选周期内获客的新用户累计付费金额；周期截至今天时即等于周期内付费金额',
  'bi.col.revenue_d0': '0日付费金额',
  'bi.col.revenue_d7': '7日付费金额',
  'bi.col.impressions': '展现',
  'bi.col.clicks': '点击',
  'bi.col.cpc': 'CPC',
  'bi.col.pending_title': '待归因打通 — Report 与 CohortSnapshot 尚未打通，漏斗指标暂不可用',
  'bi.empty.summary': '该区间暂无分端汇总数据',
  'bi.empty.breakdown': '该区间暂无投放明细数据',
  'bi.legacy.title': '历史总览（保留于下方）',
}
