...
> 这是 [Luddi](/Users/oratis/Projects/Claude/Luddi) 项目完整 Claude Code 工程化体系的参考文档。adex 的 `.claude/` 直接以此为蓝本，按 adex 的技术栈做了简化。
>
> 本文档面向：(1) 后续维护 adex `.claude/` 的人；(2) 想把这套体系挪到其他项目的人；(3) 与 Luddi 同步演进时的对照基线。
>
> **路径约定**：除非另说明，下文的相对路径均相对于 `/Users/oratis/Projects/Claude/Luddi/`。
...
[Luddi/.claude/settings.json](/Users/oratis/Projects/Claude/Luddi/.claude/settings.json)
...
[Luddi/.claude/hooks/pre-bash.sh](/Users/oratis/Projects/Claude/Luddi/.claude/hooks/pre-bash.sh)
...
[Luddi/.claude/hooks/pre-commit-gate.sh](/Users/oratis/Projects/Claude/Luddi/.claude/hooks/pre-commit-gate.sh)
...
[Luddi/.claude/hooks/pre-schema-edit.sh](/Users/oratis/Projects/Claude/Luddi/.claude/hooks/pre-schema-edit.sh)
...
[Luddi/.claude/hooks/stop-check-tests.sh](/Users/oratis/Projects/Claude/Luddi/.claude/hooks/stop-check-tests.sh)
...
[Luddi/.claude/hooks/on-compact.sh](/Users/oratis/Projects/Claude/Luddi/.claude/hooks/on-compact.sh)
...
[Luddi/.claude/rules/schema.md](/Users/oratis/Projects/Claude/Luddi/.claude/rules/schema.md)
...
[Luddi/.claude/rules/session-safety.md](/Users/oratis/Projects/Claude/Luddi/.claude/rules/session-safety.md)
...
[Luddi/.claude/rules/testing.md](/Users/oratis/Projects/Claude/Luddi/.claude/rules/testing.md)
...
[Luddi/.claude/agents/reviewer.md](/Users/oratis/Projects/Claude/Luddi/.claude/agents/reviewer.md)
...
[Luddi/.claude/agents/tester.md](/Users/oratis/Projects/Claude/Luddi/.claude/agents/tester.md)
...
[Luddi/.claude/commands/implement.md](/Users/oratis/Projects/Claude/Luddi/.claude/commands/implement.md)
...
[Luddi/.claude/commands/verify.md](/Users/oratis/Projects/Claude/Luddi/.claude/commands/verify.md)
...
[Luddi/.claude/commands/review.md](/Users/oratis/Projects/Claude/Luddi/.claude/commands/review.md)
...
[Luddi/.claude/skills/implement/SKILL.md](/Users/oratis/Projects/Claude/Luddi/.claude/skills/implement/SKILL.md)
...
[Luddi/.claude/skills/verify/SKILL.md](/Users/oratis/Projects/Claude/Luddi/.claude/skills/verify/SKILL.md)

输入 `packages` 列表 + `fix` flag。串行（**禁止并行**，内存压力）跑 `pnpm --filter <pkg> run test`，结构化报告，`fix` 模式只修一遍不循环。

### 7.3 `review/SKILL.md`

[Luddi/.claude/skills/review/SKILL.md](/Users/oratis/Projects/Claude/Luddi/.claude/skills/review/SKILL.md)

只做 orchestrator —— 把 target 传给 `reviewer` agent，捕获 Issues/Suggestions/Verdict 原样返回。**永不自己 review**（保独立性）。

## 8. CLAUDE.md —— 项目级上下文文件

[Luddi/CLAUDE.md](/Users/oratis/Projects/Claude/Luddi/CLAUDE.md)（17KB）
...
用户级 auto-memory（不在 repo，用户机器全局）：

- `~/.claude/projects/-Users-oratis-Projects-Claude-adex/memory/MEMORY.md`
- `~/.claude/projects/-Users-oratis-Projects-Claude-adex/memory/project_adex_overview.md`
- `~/.claude/projects/-Users-oratis-Projects-Claude-adex/memory/project_auth_custom_cookies.md`
- `~/.claude/projects/-Users-oratis-Projects-Claude-adex/memory/project_testing_status.md`
- `~/.claude/projects/-Users-oratis-Projects-Claude-adex/memory/reference_luddi_pattern.md`
